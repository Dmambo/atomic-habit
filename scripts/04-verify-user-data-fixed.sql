...
BEGIN
    ...
    FOR goal_record IN 
        ...
        ORDER BY created_at
    LOOP
        RAISE NOTICE 'Goal: % (%) - Due: %', goal_record.title, goal_record.category, goal_record.target_date;
    END LOOP;
    ...
    LOOP
        RAISE NOTICE 'Habit: % (Goal: %) at %', habit_record.name, habit_record.goal_title, habit_record.preferred_time;
    END LOOP;
